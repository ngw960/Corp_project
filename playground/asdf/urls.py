...
urlpatterns = [
    ...
    path('sword/', views.Sword_Page, name = 'Sword_Page'),

    path('sword_upgrade/', views.Sword_Upgrade, name = 'Sword_Upgrade'),

    path('sword_sell/<int:sword_level>/', views.Sword_Sell, name = 'Sword_Sell'),

    path('money_reset', views.Money_Reset, name = 'Money_Reset'),

    path('raising_bagger', views.Raising_Bagger_Page, name = 'Raising_Bagger_Page'),

    path('rasing_bagger_start', views.Raising_Bagger_Start, name = 'Raising_Bagger_Start'),
